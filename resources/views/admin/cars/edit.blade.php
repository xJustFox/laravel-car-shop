                                ...
                                <form class="row g-3" action="{{ route('admin.cars.update',$car) }}" method="POST">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="col-12 py-2">
                                            ...
                                            <input name="model" type="text" class="form-control form-control-sm" id="model" placeholder="Insert car model..." value="{{ $car->model}}">
                                            @error('model')
                                        ...
                                        <div class="col-12 py-2">
                                            ...
                                            <input name="color" type="text" class="form-control form-control-sm" id="color" placeholder="Insert color..." value="{{ $car->color}}">
                                            @error('color')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-12 py-2">
                                            ...
                                            <input name="kilometers" type="number" class="form-control form-control-sm" id="kilometers" placeholder="Insert kilometers..." value="{{ $car->kilometers}}">
                                            @error('kilometers')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="col-12 py-2">
                                            ...
                                            <div class="input-group input-group-sm ">
                                                ...
                                                <input name="price" type="number" class="form-control form-control-sm" id="price" aria-label="Amount (to the nearest euro)" value="{{ $car->price}}">
                                    ...
                                    <div class="col-12 d-flex">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input name="engine_size" step=".01" type="number" class="form-control form-control-sm" id="engine_size" value="{{ $car->engine_size}}">
                                            @error('engine_size')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
